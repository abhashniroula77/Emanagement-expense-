...
public class NewTrips extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        sp_yesNo = (Spinner) findViewById(R.id.spYesNo);
    ...
    public void addTrip(View v) {
        ...
        else
        {
            ...
            int selectedYesOrNo = sp_yesNo.getSelectedItemPosition();// 0 yes      1 No
            ...
            builder.setMessage(et1.getText()+"\n"
            +"\t"+et2.getText()+"\n"
                    +"\t"+et3.getText()+"\n"
                    +"\t"+et4.getText()+"\n"
                    +"\t"+et5.getText()+"\n"
                    +"\t"+et6.getText()+"\n"
                            +"\t"+sp_yesNo.getSelectedItem().toString()+"\n"
            );
